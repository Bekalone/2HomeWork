...
import com.example.a2homework.databinding.FragmentFourthBinding;
...
import com.example.a2homework.databinding.FragmentThridBinding;
...
public class ThridFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            String value = getArguments().getString("key_tv_data2");
            binding.tvData.setText(value);
        }

        Bundle bundle = new Bundle();
        bundle.putString("key_tv_data3", binding.tvData.getText().toString());
